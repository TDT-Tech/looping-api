  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
      ...
      <div  style="margin:0px auto;max-width:600px;">
        ...
        >
          <tbody>
            <tr>
              <td
                 style="direction:ltr;font-size:0px;padding:0px 10px 30px 10px;text-align:center;"
              >
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:30px 0px;word-break:break-word;"
                >
      ...
      <img
         src={LOGO_URL} style="border:0;border-radius:50%;display:block;outline:none;text-decoration:none;height:45px;width:100%;font-size:13px;" width="45" height="45"
      />
      ...
      <div
         style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:22px;font-weight:600;line-height:1.8;text-align:left;color:#000000;"
      >Sign in to Looping</div>
      ...
      >&#8202;</div>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:0px 0px 15px 0px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;line-height:1.5;text-align:left;color:#000000;"
      >Hi friend,</div>
      ...
      <div
         style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:bold;line-height:1.5;text-align:left;color:#000000;"
      ><a href={MAGIC_LINK_URL}>Click here to sign in with this magic link</a></div>
      ...
      <div
         style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;line-height:1.5;text-align:left;color:#ababab;"
      ...
      <div
         style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:12px;line-height:1.5;text-align:left;color:#707070;"
      >Drop us a line at: <a href="mailto:loopingletter@gmail.com" style="color: #C95454; text-decoration: none;">loopingletter@gmail.com</a></div>
                </td>
              </tr>
        </tbody>
      </table>
